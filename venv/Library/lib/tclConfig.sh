...
# installed.
TCL_PREFIX='F:/Dalhousie University/Process of data Sceince/Notebooks/Yolo/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='F:/Dalhousie University/Process of data Sceince/Notebooks/Yolo/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='F:/Dalhousie University/Process of data Sceince/Notebooks/Yolo/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IF:/Dalhousie University/Process of data Sceince/Notebooks/Yolo/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LF:/Dalhousie University/Process of data Sceince/Notebooks/Yolo/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='F:/Dalhousie University/Process of data Sceince/Notebooks/Yolo/venv\Library\lib\tclstub86.lib'
